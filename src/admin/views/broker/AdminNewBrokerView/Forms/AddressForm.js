      ...
      <Card>
        ...
        <CardContent>
          <Grid container spacing={3}>
            ...
            <Grid item xs={12} sm={6}>
              <InputField
                name={broker_trading_name.name}
                label={broker_trading_name.label}
                fullWidth
                variant="outlined"
              />
            </Grid>
            <Grid item xs={12} sm={6}>
              <InputField
                name={broker_website.name}
                label={broker_website.label}
                fullWidth
                variant="outlined"
              />
            </Grid>
            ...
            <Grid item xs={12} sm={6}>
              <InputField
                name={broker_address_refinment.name}
                label={broker_address_refinment.label}
                fullWidth
                variant="outlined"
              />
            </Grid>
            ...
            <Grid item xs={12} sm={6}>
              <InputField
                name={broker_industry_code.name}
                label={broker_industry_code.label}
                fullWidth
                variant="outlined"
              />
            </Grid>
            <Grid item xs={12} sm={6}>
              <InputField
                name={broker_register_number.name}
                label={broker_register_number.label}
                fullWidth
                variant="outlined"
              />
            </Grid>
