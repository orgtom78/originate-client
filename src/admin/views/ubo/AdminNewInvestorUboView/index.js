...
import NewInvestorUboFormModel from "./FormModel/NewInvestorUboFormModel";
...
const { formId, formField } = NewInvestorUboFormModel;
...
export default function NewAccount() {
  ...
  return (
    <Page className={classes.root} title="Add ubo">
      <Container maxWidth="lg">
        <React.Fragment>
          <Typography component="h1" variant="h4" align="center">
            Add an owner to {investorname}
          </Typography>
          <br></br>
          <React.Fragment>
            <Formik
