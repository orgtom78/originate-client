...
export default function NewSupplier() {
  ...
  async function _submitForm(values, actions) {
    ...
    try {
      ...
      const supplier_articles_of_association_attachment = values['supplier_articles_of_association_attachment'];
      const supplier_shareholder_list_attachment = values['supplier_shareholder_list_attachment'];
      const supplier_director_list_attachment = values['supplier_director_list_attachment'];
