...
export default function NewInvestor() {
  ...
  async function _submitForm(values, actions) {
    ...
    try {
      ...
      const investor_articles_of_association_attachment = values['investor_articles_of_association_attachment'];
      const investor_shareholder_list_attachment = values['investor_shareholder_list_attachment'];
      const investor_director_list_attachment = values['investor_director_list_attachment'];
