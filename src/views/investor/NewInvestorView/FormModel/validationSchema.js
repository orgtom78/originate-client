...
export default [
  Yup.object().shape({
    ...
    [investor_name.name]: Yup.string().required(`${investor_name.requiredErrorMsg}`),
    [investor_type.name]: Yup.string().required(`${investor_type.requiredErrorMsg}`),
    [investor_date_of_incorporation.name]: Yup.string()
      .required(`${investor_date_of_incorporation.requiredErrorMsg}`)
      .test('incdate', investor_date_of_incorporation.invalidErrorMsg, val => {
        if (val) {
    ...
    [investor_address_city.name]: Yup.string().required(`${investor_address_city.requiredErrorMsg}`),
    [investor_address_street.name]: Yup.string().required(`${investor_address_street.requiredErrorMsg}`),
    ...
    [investor_country.name]: Yup.string().required(`${investor_country.requiredErrorMsg}`),
    [investor_industry.name]: Yup.string().required(`${investor_industry.requiredErrorMsg}`),
    [investor_registration_cert_attachment.name]: Yup.string().required(`${investor_registration_cert_attachment.requiredErrorMsg}`),
  }),
