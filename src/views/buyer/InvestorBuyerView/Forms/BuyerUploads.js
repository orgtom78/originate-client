...
function BuyerUploads({value}) {
  ...
  async function get(){
    ...
    setObj(data)
    setBuyer_registration_cert_attachment(data.buyer_registration_cert_attachment);
    setBuyer_shareholder_list_attachment(data.buyer_shareholder_list_attachment);
    setBuyer_director_list_attachment(data.buyer_director_list_attachment);
    setBuyer_articles_of_association_attachment(data.buyer_articles_of_association_attachment);
  ...
  function regcertisimageorpdf(label, name) {
    ...
    if (regex.test(regcertimg)) {
      ...
      return (
        <>
          <Typography>This document is pending, please contact Originate Capital.</Typography>
        </>
      );
    }
  }
