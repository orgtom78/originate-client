...
import DirectorListView from "src/views/buyer/AdminBuyerView/Lists/directorlist.js";
import UboListView from "src/views/buyer/AdminBuyerView/Lists/ubolist.js";
import FinancialsListView from "src/views/buyer/InvestorBuyerView/Lists/financialslist.js";
...
const BuyerForm = ({ className, value, ...rest }) => {
  ...
  const [buyer_date_of_incorporation, setBuyer_date_of_incorporation] = useState("");
            ...
            >
              ...
              {type.map((item, index) => (
                  ...
                  <Select
                    ...
                    onChange={(e) =>
                      setBuyer_industry(e.target.value)
                    }
                    required
