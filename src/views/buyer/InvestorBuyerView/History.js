      ...
      <Table className={classes.table} size="small" aria-label="simple table">
        ...
        <TableBody>
            <TableRow className={classes.tableRow}>
              ...
              <TableCell align="right">{moment(arr.buyer_supplier_year_business_relation_started).format('YYYY')}</TableCell>
            </TableRow>
            <TableRow>
            ...
            <TableRow>
              ...
              <TableCell align="right">{arr.buyer_sold_goods_description}
                </TableCell>
            </TableRow>
            <TableRow>
              <TableCell component="th" scope="row">
              ...
              <TableCell align="right">{arr.buyer_payment_terms}
                </TableCell>
            </TableRow>
            <TableRow>
              <TableCell component="th" scope="row">
              ...
              <TableCell align="right">{arr.buyer_currency}
                </TableCell>
            </TableRow>
        </TableBody>
