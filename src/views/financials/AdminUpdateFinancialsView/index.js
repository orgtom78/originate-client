...
const UpdateFinancialsForm = ({ className, value, ...rest }) => {
  ...
  async function onbalanceChange(newfile) {
    ...
    try {
      const u = newfile ? await s3Up(newfile, 'balance_sheet_attachment') : null;
  ...
  async function onincomeChange(newfile) {
    ...
    try {
      const u = newfile ? await s3Up(newfile, 'income_statement_attachment') : null;
  ...
  useEffect(() => {
    if (balance_sheet_attachment) {
      async function getjson() {
          const y = await Storage.get(`${userId}${financialsId}balance_sheet_attachment.json`, {
            level: "private",
            identityId: 'json',
            download: true
          });
  ...
  }, [userId, financialsId, balance_sheet_attachment]);

    useEffect(() => {
    if (income_statement_attachment) {
      async function getjson() {
          const y = await Storage.get(`${userId}${financialsId}income_statement_attachment.json`, {
            level: "private",
            identityId: 'json',
            download: true
          });
  ...
  }, [userId, financialsId, income_statement_attachment]);
              ...
              <Grid container spacing={3}>
                ...
                <Grid item md={12} xs={12}>
                  <TableContainer component={Paper}>
                    <Table className={classes.table} size="small" aria-label="Balaance Sheet Table">
                      <TableHead>
                        <TableRow>
                          <TableCell></TableCell>
                      ...
                      <TableBody>
                        ...
                        <TableRow>
                          ...
                          <TableCell component="th" scope="row">
                            ...
                            type="number"
                              fullWidth
                              onChange={(e) => setMarketable_securities(e.target.value)}
                              required
                        ...
                        <TableRow>
                          ...
                          <TableCell component="th" scope="row">
                            ...
                            type="number"
                              fullWidth
                              onChange={(e) =>
                                setCommon_stock(e.target.value)
                              }
                              required
                              value={common_stock || ""}
                              variant="outlined"
                        ...
                        <TableRow>
                          ...
                          <TableCell component="th" scope="row">
                            ...
                            type="number"
                              fullWidth
                              onChange={(e) =>
                                setTotal_equity(e.target.value)
                              }
                              required
                              value={total_equity || ""}
                              variant="outlined"
                ...
                <Grid item md={6} xs={12} style={{ width: "100%", maxWidth: 500, overflow: "auto" }}>
                      ...
                      <TableBody>
                        ...
                        <TableRow>
                          ...
                          <TableCell component="th" scope="row">
                            <TextField
                              type="number"
                              fullWidth
                              onChange={(e) => setOperating_expenses(e.target.value)}
                              required
                        ...
                        <TableRow>
                          ...
                          <TableCell component="th" scope="row">
                            <TextField
                              fullWidth
                              onChange={(e) => setMarketing_expenses(e.target.value)}
                              required
                        ...
                        <TableRow>
                          ...
                          <TableCell component="th" scope="row">
                            <TextField
                              fullWidth
                              onChange={(e) =>
                                setTax_expenses(e.target.value)
                              }
                              required
                              value={tax_expenses || ""}
                              variant="outlined"
