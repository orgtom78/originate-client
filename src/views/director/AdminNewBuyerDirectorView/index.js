...
import NewBuyerDirectorFormModel from './FormModel/NewBuyerDirectorFormModel';
...
const { formId, formField } = NewBuyerDirectorFormModel;
...
export default function NewAccount() {
  ...
  async function getBuyer(input) {
    try {
      ...
      const n = await {data:{listsBuyer:{items:[itemsPage1], nextToken } } };
