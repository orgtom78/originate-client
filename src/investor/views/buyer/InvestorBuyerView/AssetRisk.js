      ...
      try {
        ...
        if (data) {
          ...
          if (d[0]) {
            ...
            setBuyer_existing_disputes(d[0].buyer_existing_disputes);
            setBuyer_existing_disputes_risk(d[0].buyer_existing_disputes_risk);
            setBuyer_insurance_status(d[0].buyer_insurance_status);
            setBuyer_insurance_status_risk(d[0].buyer_insurance_status_risk);
            setBuyer_country_year_of_rating_downgrade(
              d[0].buyer_country_year_of_rating_downgrade
            );
            setBuyer_country_year_of_rating_downgrade_risk(
              d[0].buyer_country_year_of_rating_downgrade_risk
            );
            setBuyer_supplier_year_business_relation_started(
              d[0].buyer_supplier_year_business_relation_started
            );
            setBuyer_supplier_year_business_relation_started_risk(
              d[0].buyer_supplier_year_business_relation_started_risk
            );
            setBuyer_reporting_year_number_invoices(
              d[0].buyer_reporting_year_number_invoices
            );
            setBuyer_reporting_year_number_invoices_risk(
              d[0].buyer_reporting_year_number_invoices_risk
            );
            setBuyer_invoices_paid_on_time(d[0].buyer_invoices_paid_on_time);
            setBuyer_invoices_paid_on_time_risk(
              d[0].buyer_invoices_paid_on_time_risk
            );
            setBuyer_invoices_past_due_30_days(
              d[0].buyer_invoices_past_due_30_days
            );
            setBuyer_invoices_past_due_30_days_risk(
              d[0].buyer_invoices_past_due_30_days_risk
            );
            setBuyer_invoices_past_due_60_days(
              d[0].buyer_invoices_past_due_60_days
            );
            setBuyer_invoices_past_due_60_days_risk(
              d[0].buyer_invoices_past_due_60_days_risk
            );
            setBuyer_use_of_goods_purchased(d[0].buyer_use_of_goods_purchased);
            setBuyer_use_of_goods_purchased_risk(
              d[0].buyer_use_of_goods_purchased_risk
            );
            setInventory_cost_of_goods_sold_ratio(
          ...
          if (d[1]) {
            setNet_profit_previous_year(d[1].net_profit_previous_year);
          }
        }
        return;
      } catch (err) {
            ...
            <TableBody>
              ...
              <TableRow>
                ...
                <TableCell align="right">
                  <NumberFormat
                    ...
                    onValueChange={(values) => {
                      const { formattedValue, value } = values;
                      setEquity_net_operating_loss_ratio(value);
                    }}
                  />
                </TableCell>
                <TableCell align="right">
              ...
              <TableRow>
                ...
                <TableCell align="right">
                  <TextField
                    ...
                    onChange={(e) => setCost_of_goods_sold(e.target.value)}
                    required
              ...
              <TableRow>
                ...
                <TableCell align="right">
                  <TextField
                    fullWidth
                    id="buyer_reporting_year_transaction_amount"
                    onChange={(e) =>
                      setBuyer_reporting_year_transaction_amount(e.target.value)
                    }
                    required
