...
const BrokerFeeAvg = ({ className, value, ...rest }) => {
  ...
  function addamounts() {
    if (handle) {
      ...
      const nn = x.filter((e) => e.broker_fee_rate !== null && e.broker_fee_rate !== "");
      var fin = nn.map((e) => e.broker_fee_rate);
...
BrokerFeeAvg.propTypes = {
  className: PropTypes.string,
};

export default BrokerFeeAvg;
