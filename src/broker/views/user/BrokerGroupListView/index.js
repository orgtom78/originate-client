...
const BrokerUserGroupListView = () => {
  ...
  React.useEffect(() => {
    async function getUsergroups() {
      ...
      } = await API.graphql(graphqlOperation(queries.listUsergroups, { filter: filter }));
...
export default BrokerUserGroupListView;
