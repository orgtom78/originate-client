...
import DirectorListView from "src/broker/views/supplier/BrokerSupplierView/Lists/directorlist.js";
import UboListView from "src/broker/views/supplier/BrokerSupplierView/Lists/ubolist.js";
import BrokerUpdateBankView from "src/broker/views/bank/BrokerUpdateBankView/index.js";
      ...
      <React.Fragment>
        ...
        <Accordion>
          ...
          <AccordionDetails>
            <Card>
              ...
              <Divider />
              <Box display="flex" justifyContent="flex-end" p={2}>
                <Link to={`/broker/brokernewsupplierdirector/${supplierId}`}>
        ...
        <Accordion>
          ...
          <AccordionDetails>
            <Card>
              ...
              <Divider />
              <Box display="flex" justifyContent="flex-end" p={2}>
                <Link to={`/broker/brokernewsupplierubo/${supplierId}`}>
        ...
        <Accordion>
          ...
          <AccordionDetails>
            <Card>
              <CardContent>
                <BrokerUpdateBankView value={supplierId} user={userId} />
              </CardContent>
            </Card>
          </AccordionDetails>
        </Accordion>
