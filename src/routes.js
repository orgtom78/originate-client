...
import InvestorSettingsView from 'src/investor/views/settings/SettingsView';
  ...
  },
  {
    ...
    children: [
      ...
      { path: '/', element: !isInvestor ? <InvestorLoginView />  : <InvestorDashboardView />},
      { path: 'dashboard', element: !isInvestor ? <InvestorLoginView />  : <InvestorDashboardView /> },
      { path: 'buyer/:id/:buyId/:ident', element: !isInvestor ? <InvestorLoginView /> : <InvestorBuyerView />},
      ...
      { path: 'transaction/:id/:reqId', element: !isInvestor ? <InvestorLoginView /> : <InvestorTransactionView />},
