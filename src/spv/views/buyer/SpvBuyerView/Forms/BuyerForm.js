...
import DirectorListView from "src/spv/views/buyer/AdminBuyerView/Lists/directorlist.js";
import UboListView from "src/spv/views/buyer/AdminBuyerView/Lists/ubolist.js";
        ...
        <Accordion>
          ...
          <AccordionDetails>
            <Card>
              ...
              <Divider />
              <Box display="flex" justifyContent="flex-end" p={2}>
                <Link to={`/spv/spvnewfinancials/${id}`}>
        ...
        <Accordion>
          ...
          <AccordionDetails>
            <Card>
              ...
              <Divider />
              <Box display="flex" justifyContent="flex-end" p={2}>
                <Link to={`/spv/spvnewbuyerdirector/${id}`}>
