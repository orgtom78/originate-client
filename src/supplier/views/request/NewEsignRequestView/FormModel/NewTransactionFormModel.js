const model = {
  ...
  formField: {
    ...
    offer_notice_attachment: {
      ...
      label: "Offer  Notice*",
      requiredErrorMsg: "Offer notice is required",
    },
    ipu_attachment: {
      name: "ipu_attachment",
      label: "Irrevocable Payment Undertaking*",
      requiredErrorMsg: "IPU is required",
    },
    bill_of_lading_attachment: {
      name: "bill_of_lading_attachment",
      label: "Bill of Lading*",
      requiredErrorMsg: "BL is required",
    },
    ...
    ipu_signature_name: {
      ...
      label: "IPU Signature Name*",
      requiredErrorMsg: "IPU Signature Name is required",
    },
    ipu_signature_email: {
      name: "ipu_signature_email",
      label: "IPU Signature Email*",
      requiredErrorMsg: "IPU Signature Email is required",
    },
  },
};
