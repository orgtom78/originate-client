...
const scheme = [
  ...
  Yup.object().shape({
    [buyer_supplier_year_business_relation_started.name]: Yup.string().required(
    ...
    [buyer_invoices_paid_on_time.name]: Yup.string(),
    [buyer_invoices_past_due_30_days.name]: Yup.string(),
    [buyer_invoices_past_due_60_days.name]: Yup.string(),
    [buyer_invoices_past_due_90_days.name]: Yup.string(),
  }),
];
